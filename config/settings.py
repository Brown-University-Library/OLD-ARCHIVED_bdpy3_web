...
SECRET_KEY = os.environ['BDPY3WEB__SECRET_KEY']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = json.loads( os.environ['BDPY3WEB__DEBUG_JSON'] )  # will be True or False

ADMINS = json.loads( os.environ['BDPY3WEB__ADMINS_JSON'] )

ALLOWED_HOSTS = json.loads( os.environ['BDPY3WEB__ALLOWED_HOSTS'] )  # list
...
LOGGING = {
    ...
    'handlers': {
        'logfile': {
            ...
            'filename': os.environ.get(u'BDPY3WEB__LOG_PATH'),
            'formatter': 'standard',
        },
        'console':{
            'level':'DEBUG',
